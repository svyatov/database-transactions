...
def run(s, t):
    ...
    t.note("B targets WHERE value = 10. In B's snapshot row 1 still qualifies — but it's locked by A, so B waits.")
    ...
    eq(result.affected, 0)  # UPDATE 0 — the row slipped away
