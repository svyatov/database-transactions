...
export default scenario({
  ...
  claim:
    "SELECT ... FOR UPDATE SKIP LOCKED silently skips locked rows, so concurrent workers each grab a different row without ever waiting — the backbone of SQL job queues.",
  setup: `
