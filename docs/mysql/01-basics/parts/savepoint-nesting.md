<!-- GENERATED by `bun run gen` from scenarios/mysql/01-basics/savepoint-nesting.ts — do not edit by hand. -->
...
<small>Verified against MySQL 8.4.10 · [Run it yourself](/about/run-locally) · [Scenario source](https://github.com/svyatov/database-transactions/blob/main/scenarios/mysql/01-basics/savepoint-nesting.ts)</small>
