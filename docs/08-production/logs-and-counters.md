...
A [deadlock](/03-locking/deadlocks) that's caught by a
[retry wrapper](/05-patterns/retrying-serialization-failures) never reaches your error
...
<<< ../../scenarios/08-production/deadlock-counter.ts#demo{ts}
