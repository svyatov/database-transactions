...
<<< ../../scenarios/02-isolation/no-dirty-reads.ts#demo{ts}
...
<<< ../../scenarios/02-isolation/non-repeatable-read.ts#demo{ts}
...
<<< ../../scenarios/02-isolation/phantom-read.ts#demo{ts}
...
- Multi-statement read-modify-write logic at this level is exposed to
  [lost updates](/02-isolation/lost-update) — the most common real-world transaction bug.
