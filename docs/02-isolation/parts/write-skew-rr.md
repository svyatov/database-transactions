<!-- GENERATED by `bun run gen` from scenarios/02-isolation/write-skew-rr.ts — do not edit by hand. -->
...
<small>Verified against PostgreSQL 18.4 · [Run it yourself](/about/run-locally) · [Scenario source](https://github.com/svyatov/postgres-transactions/blob/main/scenarios/02-isolation/write-skew-rr.ts)</small>
