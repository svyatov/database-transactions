...
is otherwise disabled. The second is the last line of defense: if that vacuum never completes —
blocked by the same enemies as always, a [long-running transaction](/postgres/04-mvcc/long-transactions),
