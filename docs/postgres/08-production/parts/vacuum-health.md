<!-- GENERATED by `bun run gen` from scenarios/postgres/08-production/vacuum-health.ts — do not edit by hand. -->
...
A> SELECT pg_stat_force_next_flush();
...
<small>Verified against PostgreSQL 18.4 · [Run it yourself](/about/run-locally) · [Scenario source](https://github.com/svyatov/database-transactions/blob/main/scenarios/postgres/08-production/vacuum-health.ts)</small>
