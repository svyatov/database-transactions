...
<<< ../../scenarios/04-mvcc/long-transactions.ts#demo{ts}
...
nothing*, while every UPDATE adds another [dead tuple](/04-mvcc/dead-tuples-and-bloat)
...
[DDL outage](/03-locking/table-locks-and-ddl)), a many-hour analytics query against the
