<!-- GENERATED by `bun run gen` from scenarios/04-mvcc/dead-tuples-and-bloat.ts — do not edit by hand. -->
...
<small>Verified against PostgreSQL 18.4 · [Run it yourself](/about/run-locally) · [Scenario source](https://github.com/svyatov/postgres-transactions/blob/main/scenarios/04-mvcc/dead-tuples-and-bloat.ts)</small>
