...
<<< ../../scenarios/01-basics/autocommit-visibility.ts#demo{ts}
...
<<< ../../scenarios/01-basics/aborted-transaction.ts#demo{ts}
...
- Seeing `current transaction is aborted, commands ignored until end of transaction block` in
  ...
  error handling — or in [savepoints](/01-basics/savepoints).
